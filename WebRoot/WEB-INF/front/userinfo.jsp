		...
		<div>
			...
			<div class="middle" style="height: 550px">
				...
				<div class="right" style="height: 550px">
						...
						<center>
						<span style="font-family: 华文新魏;">我的信息</span>
						<br/>
						<span>时间：<%=(new java.util.Date()).toLocaleString()%></span>
					</center>


					<form action="<%=basePath%>/updateUserAction?flag=user" method="post">
						...
						<table>
							<tr>
								...
								<td>
									<input type="hidden" name="id" value="${sessionScope.user_now.id }" />
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<input type="text" name="realname" disabled="disabled"
										value="${sessionScope.user_now.realname }" />
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<input type="text" name="idnumber" id="idnumber"
										disabled="disabled" value="${sessionScope.user_now.idnumber }" />
								</td>
							</tr>
							<tr>
								<td>
							...
							<tr>
								...
								<td>
									<input disabled="disabled" type="text" name="sex_now"
										value="${sessionScope.user_now.sex }" id="sex_now" />
							...
							<tr>
								...
								<td>
									<input id="birthplace_now" disabled="disabled" type="text"
										name="birthplace_now"
										value="${sessionScope.user_now.birthplace }" />
							...
							<tr>
								...
								<td>
									<input id="landscape_now" disabled="disabled" type="text"
										name="landscape_now"
										value="${sessionScope.user_now.landscape }" />
							...
							<tr>
								...
								<td>
									<input id="nation_now" disabled="disabled" type="text"
										name="nation_now" value="${sessionScope.user_now.nation }" />
							...
							<tr>
								...
								<td>
									<input id="education_now" disabled="disabled" type="text"
										name="education_now"
										value="${sessionScope.user_now.education }" />
							...
							<tr>
								...
								<td>
									<input id="degree_now" disabled="disabled" type="text"
										name="degree_now" value="${sessionScope.user_now.degress }" />
							...
							<tr>
								...
								<td>
									<input disabled="disabled" type="text" name="workdepartment"
										value="${sessionScope.user_now.workdepartment }" />
									<br />
								</td>
							</tr>
							<tr>
								...
								<td>
									<input disabled="disabled" type="text" name="department"
										value="${sessionScope.user_now.department }" />
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<input disabled="disabled" type="text" name="worked"
										value="${sessionScope.user_now.worked }" />
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<input disabled="disabled" type="text" name="professionaltile"
										value="${sessionScope.user_now.professionaltile }" />
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<input disabled="disabled" type="text" name="health"
										value="${sessionScope.user_now.health }" />
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<input disabled="disabled" type="text" name="phone"
										value="${sessionScope.user_now.phone }" />
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<input disabled="disabled" type="text" name="address"
										value="${sessionScope.user_now.address }" />
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<textarea rows="1" cols="30" name="experience"
										disabled="disabled">${sessionScope.user_now.experience }</textarea>
								</td>
							</tr>
