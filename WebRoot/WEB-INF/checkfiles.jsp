			...
			<div class="middle" style="height: 650px">
				...
				<div class="right" style="height: 650px">
					<center>
						...
						<span>用户名：</span><span>${user.realname }</span>&nbsp;&nbsp;&nbsp;&nbsp;
						<span>身份证号：</span><span>${user.idnumber }</span>
						<input type="hidden" name="uid" value="${user.id }" id="uid" />
						<input type="hidden" name="idnum" value="${user.idnumber }"
							id="idnum" />
					...
					<div style="position: absolute; left: 460px; top: 150px;">
						...
						<script type="text/javascript">
	var fpv = new FlexPaperViewer(basePath + 'viewOnline/FlexPaperViewer',
			'viewerPlaceHolder', {
				config : {
					SwfFile : escape(basePath + "swf/nothisfile.swf"),//要浏览的swf文件
