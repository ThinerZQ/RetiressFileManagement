...
public class Doc2PdfUtil {
	...
	private static String OFFICE_HOME = "C:\\Program Files\\OpenOfficePortable";
	...
	public static STATUS convert2PDF(File inputFile, File pdfFile) {
		...
		try {
			startService();
			Logger.getLogger(Doc2PdfUtil.class).info(
					"进行文档转换:" + inputFile.getName());
		...
		Logger.getLogger(Doc2PdfUtil.class).info(
				"生成" + pdfFile.getName() + "耗费：" + min + "分" + s + "秒");
		if (pdfFile.exists()) {
